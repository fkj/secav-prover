...
module
  Prover(Phase(..), equal_phase, Prule(..), rules, rho, maxFunTm, maxFun,
          generate_new, branchDone, flatten, subterm_tm, subterm_fm, subterms,
          abdDone, peff, secavTree, secavProver)
  where {
